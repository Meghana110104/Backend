...
public class LeaveRequestImplementation implements LeaveRequestService {
  ...
  private ModelMapper modelmapper;
    ...
    public ResponseEntity<String> add(LeaveRequestDTO data) {
		...
		String mobileNumber = data.getMobileNo();
		String endDate = data.getEndDate();
		Employee emp = empRepo.findByMobileNo(mobileNumber) .orElseThrow(() -> new ResourceNotfound("Employee not found for mobile number: " + data.getMobileNo()));
